...
| <img src="https://tinyurl.com/4mj8tm2z" width="200"> | Fullstack JavaScript Developer, Data Analyst, Focused on Automatization | Desarrollador Fullstack Javascript, Analista de Datos, Enfocado en Automatización |
| :--------------------------------------------------: | :---------------------------------------------------------------------- | :-------------------------------------------------------------------------------- |
...
- Me he capacitado como **desarrollador web** aprovechando cada recurso disponible:
  ...
  2. Cursos de Desafio Latam, Santander Open Academy, VScode Edu, entre otros
  3. Mentorias grabadas por profesionales como equipo FreeCodeCamp, MoureDev, MiduDev, HolaMundo y Soy Dalto, a quienes agradezco su enseñanzas en nuestro idioma nativo español.
- Tengo experiencia en el sector IT como **analista de datos**, en equipos multidiciplinarios y ambientes de trabajo remotos.
...
- 🚀 **Fullstack JS Scholarship:** Egresado del bootcamp intensivo de MindHub y SENCE.
- 🔥 **Certificación Python**: Introducción a la programación con python (Santander Open Academy)
- 🐍 **Certificación Python:** Introducción al Análisis de Datos con python (Desafío Latam).
- 📚 **CS50x Harvard 2026:** Estudiante activo del curso de Ciencias de la Computación de la Universidad de Harvard.
